...
class SharedPref {
  ...
  static Future<void> saveIsCompanySharedPreference(bool isCompany) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setBool(isCompanySharedPreferenceKey, isCompany);
  }

  static Future<void> saveFullNameSharedPreference(String fullname) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setString(fullNameSharedPreferenceKey, fullname);
  }

  static Future<void> saveCompanyNameSharedPreference(
  ...
  static Future<void> saveCompanyDescriptionSharedPreference(
      String desc) async {
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await preferences.setString(
  ...
  static Future<void> saveCompanyServiceTypeSharedPreference(
