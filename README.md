...
<h2 align="center" id="Features"> :label: Features</h2>
  ...
  #### Main Features
   ...
   :point_right: Chat/Contact - The most important method to preserve a customer seller relationship is a proper way of commmunication. So We have introduced an end-to-end encrypted chat system.<br/>
